...
register_sidebar(
        array(
            'name' => 'Right Sidebar',
            'id' => 'right-sidebar',
            'before_widget' => '<div class="col-md-4 padding-right-0" id="right-sidebar">',
            'after_widget' => '</div>', 
));
...
function custome_theme_enqueue_styles() { 
    wp_enqueue_style('custome-style.css', get_template_directory_uri() . '/css/custome-style.css', array(), '1', 'all');
    wp_enqueue_style('custome-style.css');
    wp_enqueue_style('stylesheet', get_stylesheet_uri(), array(), '1', 'all');
}

add_action('wp_enqueue_scripts', 'custome_theme_enqueue_styles');
